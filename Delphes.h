...
// Sat Mar  9 18:41:58 2019 by ROOT version 6.17/01
...
public :
   ...
   Float_t Electron_mass = 0.510998;

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxEvent = 1;
   static constexpr Int_t kMaxParticle = 3128;
   static constexpr Int_t kMaxTrack = 126;
   static constexpr Int_t kMaxTower = 259;
   static constexpr Int_t kMaxEFlowTrack = 126;
   static constexpr Int_t kMaxEFlowPhoton = 89;
   static constexpr Int_t kMaxEFlowNeutralHadron = 134;
